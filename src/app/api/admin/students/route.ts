    ...
    try {
        ...
        const [students, total] = await Promise.all([
            User.find(filter)
                ...
                .select('fullName email mobileNumber username rollNumber sessionFrom sessionTo isProfileComplete status createdAt batch classId provider rejectionReasons semester programId joiningMonth joiningYear courseEndDate')
